...
class Header extends React.Component {
  ...
  handleAddFormSubmit(event) {
    ...
    const { newName, newImage, newInfo, newTel, newTelegram } = this.state;
      ...
      <header>
        ...
        <div className="btns-bar">
          ...
          <button
            ...
            onClick={this.handleShowSearchBtnClick}
          >
          ...
          <button
            ...
            onClick={this.handleShowAddFormBtnClick}
          >
        ...
        <input
          ...
          hidden={!this.state.isSearchBoxVisible}
        />

        {/* Add Contact Form */}
        <form
          className="add-contact"
          hidden={!this.state.isAddFormVisible}
